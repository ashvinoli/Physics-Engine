...
* For Pendulum do as engine, the only difference is providing the hinge, length of pendulum and initial angle. To use n-compound pendulum system switch to "cp" branch. 
